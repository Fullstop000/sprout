...
|--------|----------|-------|-----------|
| `Approved for Plan` | [2026-03-07-react-tool-calling.md](2026-03-07-react-tool-calling.md) | Replace Plan-then-Execute + replan with a ReAct tool-calling loop in `execution/` | Implementation plan created at [docs/plans/2026-03-07-react-tool-calling.md](../plans/2026-03-07-react-tool-calling.md) |
